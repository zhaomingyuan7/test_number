function compare_number_with_input(number1,number2){
    var the_first = get_every_number(number1);
    var the_second = get_every_number(number2);
    var x = 0,y = 0;
    for(var i = 0;i < 4;i ++){
       for(var j = 0;j < 4;j ++){
...
function guess_button(){
    ...
    z++;
    var b = compare_number_with_input(number,random_number)
    if(z == 6 ){
        z = 0;
